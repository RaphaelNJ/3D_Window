...
Le projet a été initialement développé en un week-end en C, en utilisant le terminal pour afficher les images. C'était ma façon de prouver qu'un jeu 3D peut fonctionner dans un terminal. Malheureusement, j'ai perdu les fichiers originaux, donc je les ai réécrits en utilisant cette fois JavaScript pour gagner du temps et être le plus compréhensible possible (de toute façon il ne fait que 500 lignes au total). Je n'ai pas eu le temps d'implémenter les textures, donc les surfaces sont affichées dans une seule couleur.
...
Pour installer et exécuter 3D_Window, veuillez suivre les étapes suivantes :

1. Clonez ce référentiel sur votre machine locale.
2. Ouvrez une fenêtre de terminal et accédez au répertoire du projet.
3. Lancez un navigateur Web et ouvrez le fichier `index.html`.
